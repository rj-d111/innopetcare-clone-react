...
export default function Options() {
  return (
    <div className="flex flex-col justify-center m-10">
      <a
        class="py-2 px-10 rounded-full font-medium select-none border text-yellow-800 dark:text-white bg-white dark:bg-yellow-800 transition-colors hover:border-yellow-900 hover:bg-yellow-900 hover:text-white dark:hover:text-white mb-4 self-start"
        href="/"
      >
        ⪻ Back
      </a>
    ...
    <a href="/content-listing-page">
      <div className="bg-white p-4 rounded-lg shadow-md flex flex-col h-full">
        <img
          ...
          className="rounded-t-lg h-40 w-full object-cover object-top"
        />
