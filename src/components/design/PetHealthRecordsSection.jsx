...
export default function PetHealthRecordsSection() {
  ...
  return (
    <>
      ...
      {isDeleteModalOpen && (
        <PetHealthRecordsSectionModalDelete
      ...
      <div className="p-6 md:max-w-md mx-auto bg-gray-100 shadow-md rounded-lg space-y-4 h-full">
        <div className="bg-yellow-100 p-4 rounded-md">
          <h2 className="text-lg font-semibold">Pet Health Records Section</h2>
          <p className="text-sm text-gray-700">
            Manage your pet's health record sections, such as vaccinations,
        ...
        {shouldShowWarning ? (
          <div role="alert" className="alert alert-warning">
            ...
            <span>
              Please add at least a section for Pet Health Records 
            </span>
          </div>
        ) : (
