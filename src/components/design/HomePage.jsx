  ...
  return (
    <>
      ...
      <div className="bg-yellow-100 p-4 rounded-md">
        ...
        A homepage is a webpage that serves as the starting point of a website. When you first visit the website, this is the one you will see first.        </p>
      </div>
      ...
      <div className="space-y-1">
        <label className="block text-sm font-medium">Background Picture</label>
        <input
          type="file"
          accept="image/*"
