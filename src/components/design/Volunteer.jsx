...
import VolunteerPageModal from "./VolunteerPageModal";
  ...
  useEffect(() => {
    const fetchSections = async () => {
      try {
        ...
        toast.error("Error fetching Volunteer sections.");
      }
    };
      ...
      <div className="p-6 md:max-w-md mx-auto bg-gray-100 shadow-md rounded-lg space-y-4 min-h-full">
        <div className="bg-yellow-100 p-4 rounded-md">
          ...
          <p className="text-sm text-gray-700">
            Manage your volunteer sections to engage with your audience.
          </p>
        </div>
        ...
        {shouldShowWarning ? (
          ...
          <div role="alert" className="alert alert-success p-4">
            ...
            <span>"Volunteer" page is successfully configured.</span>
          </div>
        )}
